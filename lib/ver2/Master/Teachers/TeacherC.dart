...
class _TeacherCalendarState extends State<TeacherCalendar> {
  ...
  List<Map<String, dynamic>> _getEvents(DateTime day, List<Map<String, dynamic>> lessons) {
    ...
    return lessons
        .where((lesson) =>
    lesson['teacherId'] == widget.teacherId &&  // 특정 학생의 수업만 가져오기
  ...
  Widget build(BuildContext context) {
    DateTime tmp1 = DateTime(2025, 1, 1);
    ...
    return Consumer(
        builder: (context, provider, child){
          ...
          String teacherName = teachers[widget.teacherId]['name'];
          return Scaffold(
            appBar: AppBar(
              title: Text("$teacherName님의 캘린더",
