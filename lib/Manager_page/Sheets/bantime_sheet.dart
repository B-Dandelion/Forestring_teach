...
class banTime_sheet extends StatefulWidget {
  const banTime_sheet({super.key});

  @override
  State<banTime_sheet> createState() => _banTime_sheet();
}

class _banTime_sheet extends State<banTime_sheet>{
  @override
                      ...
                      children: [
                        ...
                        TextButton(onPressed: () => _showDialog(
                          CupertinoPicker.builder(
                            ...
                            child: Text('${TeacherNameMap[TeacherID]} 선생님',
  ...
  void onSavePressed(BuildContext context) async{
    if(formKey.currentState!.validate()){
      ...
      await FirebaseFirestore.instance.collection('teacher')
          .doc(TeacherID).collection('BanTime')
          .doc(DateFormat('yyyyMMdd').format(tapday))
          .set({'0': DateTime(tapday.year,tapday.month,tapday.day,taptime1.hour,taptime1.minute),
        '1': DateTime(tapday.year,tapday.month,tapday.day,taptime2.hour,taptime2.minute)
      });
    }
